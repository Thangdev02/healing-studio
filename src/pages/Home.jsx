            ...
            <div className='container flex'>
                ...
                <div className="flex-1 max-w-[520px] z-10 " style={{display: 'flex', flexDirection: 'column',justifyContent: 'center'}}>
                    ...
                    <p className="text-gray-200 text-lg leading-relaxed mb-4">
                        Bộ ảnh cưới PreWedding của cô dâu Nguyễn Thị Mai và chú rể
                    </p>
                    <p className="text-gray-200 text-lg leading-relaxed mb-8">
                        Trần Lê Hải tại Rạch Giá, An Giang
                    </p>
                    <p className="text-gray-200 text-lg leading-relaxed mb-2">
                        243 tấm ảnh, 32 video
                    </p>
                ...
                >
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/3 -translate-y-1/2">
                        ...
                        <motion.img
                            ...
                            className="absolute w-[500px] h-[372px] object-cover shadow-2xl z-10"
                        />
                        ...
                        <motion.img
                            ...
                            transition={{ duration: 0.5 }}
                            className="absolute w-[495px] h-[370px] object-cover shadow-2xl z-20 translate-y-[-10px]"
                        />
                        ...
                        <motion.img
                            ...
                            transition={{ duration: 0.5 }}
                            className="relative w-[495px] h-[370px] object-cover shadow-2xl z-30"
                        />
                    </div>
                </motion.div>
            </div>
